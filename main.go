...
// ginkgo -focus=consumer ./... -- -test.bench=. -library=confluent-poll -num=1000 -size=1000 -brokers=localhost:29092 -topic=hello_world
// ginkgo -focus=consumer ./... -- -test.bench=. -library=sarama -num=1000 -size=1000 -brokers=localhost:29092 -topic=hello_world
// ginkgo -focus=consumer ./... -- -test.bench=. -library=kafkago -num=1000 -size=1000 -brokers=localhost:29092 -topic=hello_world
// ginkgo -focus=consumer ./... -- -test.bench=. -library=franz -num=1000 -size=1000 -brokers=localhost:29092 -topic=hello_world
